...
public class PeopleController implements Serializable {
    ...
    @EJB
    private session.PeopleFacade ejbFacade;
    ...
    public People getPeople(java.lang.Integer id) {
    ...
    public static class PeopleControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getPeople(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof People) {
                ...
                return getStringKey(o.getIdpeople());
            } else {
